...
import 'gym_games_model.dart';
export 'gym_games_model.dart';

class GymGamesWidget extends StatefulWidget {
  const GymGamesWidget({super.key});

  @override
  State<GymGamesWidget> createState() => _GymGamesWidgetState();
}

class _GymGamesWidgetState extends State<GymGamesWidget> {
  late GymGamesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GymGamesModel());
