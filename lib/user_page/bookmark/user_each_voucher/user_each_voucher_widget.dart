...
import 'user_each_voucher_model.dart';
export 'user_each_voucher_model.dart';

class UserEachVoucherWidget extends StatefulWidget {
  const UserEachVoucherWidget({super.key});

  @override
  State<UserEachVoucherWidget> createState() => _UserEachVoucherWidgetState();
}

class _UserEachVoucherWidgetState extends State<UserEachVoucherWidget>
    with TickerProviderStateMixin {
  late UserEachVoucherModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserEachVoucherModel());
